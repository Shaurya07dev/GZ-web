...
/// The artist portal's "More" tab — a full screen now, not a slide-out
/// drawer, so the fourth bottom-nav destination is a real page you land on
/// rather than an overlay. Same [artistMenu] data the drawer used to render
/// (real routes only, nothing invented), just laid out for a screen instead
/// of a 320px-wide panel.
class ArtistMoreScreen extends ConsumerWidget {
  const ArtistMoreScreen({super.key});

  static const path = '/dashboard/more';
