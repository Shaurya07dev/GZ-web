...
export const mockArtists: ArtistProfile[] = [
  {
    ...
    verification: { tier1SocialMedia: true, tier2ActivePlan: true, tier3FirstSale: true },
    socialLinks: [
  ...
  },
  {
    ...
    verification: { tier1SocialMedia: true, tier2ActivePlan: true, tier3FirstSale: true },
    socialLinks: [
      { platform: "instagram", url: "https://www.instagram.com/arjunmehta.sculpture/" },
  ...
  },
  {
    ...
    verification: { tier1SocialMedia: true, tier2ActivePlan: false, tier3FirstSale: false },
    socialLinks: [{ platform: "instagram", url: "https://www.instagram.com/kavya.frames/" }],
  },
  {
    ...
    verification: { tier1SocialMedia: true, tier2ActivePlan: true, tier3FirstSale: false },
    socialLinks: [{ platform: "instagram", url: "https://www.instagram.com/rohan.prints/" }],
  },
  {
    id: "ananya-deshmukh",
  ...
  },
  {
    ...
    verification: { tier1SocialMedia: true, tier2ActivePlan: false, tier3FirstSale: true },
    socialLinks: [{ platform: "youtube", url: "https://www.youtube.com/@ishaankapoorstudio" }],
  },
  {
    ...
    profileImageUrl: "/early-program/avatar-1.png",
    verification: { tier1SocialMedia: false, tier2ActivePlan: true, tier3FirstSale: true },
    socialLinks: [],
  },
];
