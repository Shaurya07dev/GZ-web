...
import { Mail, Phone, Fingerprint, RotateCcw, Repeat2, Check } from "lucide-react";
...
const FAQ = [
  {
    ...
    answer:
      "Every artwork ships with a Certificate of Authenticity. Once delivered, open it under My Collection to see the certificate number, issue date, and NFC/QR tag status.",
  },
  {
    icon: RotateCcw,
    question: "Can I return or cancel an order?",
    answer:
      "Orders can be cancelled before dispatch. Refunds credit to your GalleryZone wallet as store credit and apply automatically at your next checkout.",
  },
  {
    icon: Repeat2,
    question: "How does reselling my artwork work?",
    answer:
      "Any artwork in your collection can be listed for resale from the Resale page. This demo covers listing and withdrawing — buyer matching isn't wired to a live marketplace yet.",
  },
];

// Ticket submission isn't wired to a live support inbox in this demo — same
// honest-mock pattern as the Artist/Aggregator equivalents.
export function CollectorSupportView() {
  const { data: tickets } = useCustomerSupport();
  const submitMutation = useSubmitCustomerTicketMutation();
        ...
        >
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              placeholder="e.g. Question about my delivered artwork"
              className="h-10"
            />
          </div>
