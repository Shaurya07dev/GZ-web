...
// The public verify URL that will be encoded into the NFC tag's NDEF payload.
// The NFC writer programs exactly this string onto the chip.
function buildVerifyUrl(artworkId: string): string {
  const base =
    typeof window !== "undefined"
      ? window.location.origin
      : "https://galleryzone.com";
  return `${base}/verify/${artworkId}`;
}
...
export function LinkNfcDialog({
  ...
  const verifyUrl = buildVerifyUrl(artworkId);
