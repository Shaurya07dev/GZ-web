...
const Flag = ({ code }: { code: string }) => (
  // eslint-disable-next-line @next/next/no-img-element -- external CDN, no Next image domain config needed
  <img
...
export function UniSwapDialog({
  ...
  return (
    <div className="theme-injected relative w-max font-sans">
      <button
        type="button"
          ...
          <>
            ...
            <div className="pointer-events-none fixed inset-0 z-[999] flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="uniswap-scrollbar flex-1 overflow-y-auto pb-4">
                  {filteredCountries.length === 0 ? (
                    <div className="flex h-[9.5rem] items-center justify-center text-sm text-muted-foreground">
                      No countries found
                    </div>
                  ) : (
      ...
      <style>{`
        .uniswap-scrollbar::-webkit-scrollbar {
          width: 4px;
        }
        .uniswap-scrollbar::-webkit-scrollbar-thumb {
          background: hsl(var(--border));
          border-radius: 10px;
        }
        .uniswap-scrollbar::-webkit-scrollbar-track {
