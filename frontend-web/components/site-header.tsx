...
const FEATURED_ARTWORK = mockArtworks.find(
  (artwork) => artwork.id === "ancestral-bronze-study"
)!;
    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/75 backdrop-blur-md">
      <div className="mx-auto flex h-20 max-w-[1440px] items-center justify-between gap-4 px-6 lg:px-10">
                ...
                <div className="grid w-[560px] grid-cols-[1fr_1.2fr] gap-4 p-2">
                  ...
                  >
                    ...
                    <div className="relative">
                      <p className="text-xs text-white/70">Verified original</p>
                  ...
                  <ul className="grid gap-1">
                    {EXPLORE_CATEGORIES.map(({ category, label, count }) => (
                      <li key={category}>
                        <NavigationMenuLink
                          render={
                            <Link
                    ...
                    <li>
                      <NavigationMenuLink
                        render={
                          <Link
                            href="/marketplace"
                            className="font-medium text-gold-bright"
                          />
                        }
                      >
                        Browse all artworks
              ...
              <NavigationMenuContent>
                <div className="grid w-[420px] gap-1 p-2">
                  {SELL_WITH_US.map((option) => (
                    <NavigationMenuLink
                      key={option.href}
                      render={<Link href={option.href} className="items-start gap-3" />}
                    >
                      <option.icon
                  ...
                  <NavigationMenuLink
                    render={<Link href="/about#how-it-works" className="gap-2" />}
                  >
                    <ShieldCheck className="size-4 text-gold-bright" strokeWidth={1.75} />
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          <Button variant="ghost" size="icon" render={<Link href="/account/wishlist" aria-label="Wishlist" />}>
